...
class SecurityHeaders
{
    ...
    /**
     * Detect origins that may serve Vite/Laravel assets in non-production.
     *
     * Includes:
     *   - Vite HMR dev server (default port 5173).
     *   - Configured APP_URL and ASSET_URL origins.
    ...
    private function getViteDevOrigins(): array
    {
        ...
        // Add the configured APP_URL and ASSET_URL origins so absolute asset
        // URLs generated by Laravel do not get blocked by CSP.
        ...
        // Add the current request origin in case the app is accessed via a
        // different hostname (e.g. localhost vs 127.0.0.1).
        $requestOrigin = $this->originFromUrl(request()->getSchemeAndHttpHost());
    ...
    /**
     * Extract host:port from a URL string, or null if invalid.
     */
