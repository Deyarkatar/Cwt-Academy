...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                ...
                // 2026 hardening: real server-side prepared statements (no
                // client-side emulation) and a hard ban on stacked queries.
    ...
    */
    ...
    'redis' => [
        ...
        // Read replica for session/cache offloading in multi-node deployments.
        'queue' => [
            'url' => env('REDIS_URL'),
            'host' => env('REDIS_HOST', '127.0.0.1'),
            'username' => env('REDIS_USERNAME'),
