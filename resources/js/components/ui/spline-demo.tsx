...
function useHeroData() {
    ...
    return {
        ...
        isKurdish: mount.dataset.isKurdish === 'true',
    };
}
...
export function SplineSceneBasic() {
    ...
    const isRtl = data.isKurdish; // Kurdish/RTL: robot left, text right. English/LTR: text left, robot right.
