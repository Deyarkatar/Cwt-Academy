...
{
    /**
     * The real glossy black robot is a Spline 3D scene, not a static image.
     * This test guards the built robot JS assets and proves the old fake SVG
     * robot cannot reappear at /images/hero-robot.svg.
     */
    ...
    private function findBuiltAsset(string $pattern): string
    {
        ...
        $this->assertIsArray($files, "Built asset matching {$pattern} could not be scanned.");
    ...
    public function test_deleted_fake_svg_robot_is_not_accessible(): void
    {
        ...
        $response = $this->get('/images/hero-robot.svg');
